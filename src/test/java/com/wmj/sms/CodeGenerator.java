...
//            public String outputFile(TableInfo tableInfo) {
//                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
//                return projectPath + "/src/main/java/" + javaPath + "/vo/" + tableInfo.getEntityName() + fileSuffix;
//            }
//
//        });
//
...
//        strategy.setSuperControllerClass("com.wmj.sms.base.BaseController");
//        strategy.setEntityLombokModel(true);//启用lombok注解
//        strategy.setChainModel(true);//启用lombok链式注解
//        strategy.setInclude("wmj_t_stu_apply");
//        strategy.setTablePrefix("wmj_t_");//去表前缀配置
